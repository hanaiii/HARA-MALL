...
public class SeckillKeys {
    ...
    public static final String MQ_DELAY_TOPIC = "seckill-order-info-delay-topic";
    public static final String REDIS_SECKILL_ORDER_KEY = "product-seckill-order:";
    public static final String REDIS_SECKILL_SIMPLE_ORDER_PRODUCT = "seckill_order_product:";
}
